 ...
 */
public class AdaptadorComentarioSoloPelicula
        extends RecyclerView.Adapter<AdaptadorComentarioSoloPelicula.ViewHolder> {


    List<Comentario> comentarios;
    Context context;
    infoSoloPeliculas mainFragment;

    public AdaptadorComentarioSoloPelicula(){}

    public AdaptadorComentarioSoloPelicula(List<Comentario> comentarios, infoSoloPeliculas mainFragment) {
